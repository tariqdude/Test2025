...
export class CommandExecutionError extends AppError {
  constructor(command: string, exitCode: number | null, signal: NodeJS.Signals | null, stdout: string, stderr: string, message: string = 'Command execution failed') {
...
export class FileSystemError extends AppError {
  constructor(operation: string, filePath: string, originalError: Error, message: string = 'File system operation failed') {
...
export class AnalysisError extends AppError {
  constructor(checkerName: string, originalError: Error, message: string = 'Analysis failed for checker') {
...
export class ConfigurationError extends AppError {
  constructor(configKey: string, message: string = 'Invalid configuration') {
...
export class NetworkError extends AppError {
  constructor(url: string, status: number, originalError?: Error, message: string = 'Network request failed') {
